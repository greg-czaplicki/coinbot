...
def load_config() -> AppConfig:
    ...
    cfg = AppConfig(
        copy=CopyConfig(
            ...
            source_activity_enabled=_get_bool(
                "COPY_SOURCE_ACTIVITY_ENABLED",
                CopyConfig.source_activity_enabled,
            ),
            ...
            source_ws_reseed_sec=int(
                os.getenv(
                    "COPY_SOURCE_WS_RESEED_SEC",
                    CopyConfig.source_ws_reseed_sec,
                )
            ),
